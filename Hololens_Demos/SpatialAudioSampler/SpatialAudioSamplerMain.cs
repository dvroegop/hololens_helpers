...
using SpatialAudioSampler.Common;
...
namespace SpatialAudioSampler
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class SpatialAudioSamplerMain : IDisposable
    {
        ...
        public SpatialAudioSamplerMain(DeviceResources deviceResources)
        {
